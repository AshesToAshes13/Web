        ...
        <div v-else>
          ...
          >
            ...
            >
              <span
                v-if="movies.includes(file.file_name.split('.').pop())"
                class="flex max-w-[250px] truncate font-bold text-[#ef7665] text-[13px] leading-[15px]"
                style="word-break: break-word"
              >
                <span class="whitespace-nowrap overflow-hidden text-ellipsis">
              ...
              <div
                v-if="time && size"
                class="flex justify-between w-full text-[#7E7E80] dark:text-gray-300 "
              >
                <p class="text-[12px] leading-[15px] mt-[1px] h-1[px font-normal">
                  {{ size }}
                </p>
                ...
                >
                  <p
                    class="block font-bold text-[12px] leading-[13px] top-1 h-[13px]"
                  >
                    {{ time }}
                  </p>
                </div>

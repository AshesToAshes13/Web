...
export default {
  ...
  methods: {
    ...
    getTimeValue () {
      if (
        this.dateTime !== '0001-01-01T00:00:00'
      ) {
        ...
        if (
          ...
          const hours = this.pad2(dateTime.getHours())
          const minutes = this.pad2(dateTime.getMinutes())
    ...
    onSave () {
      ...
      this.$emit('changeDates', dateTimeString)
    },
    resetCalendar () {
      const dateTimeString = '0001-01-01T00:00:00'
      this.$emit('changeDates', dateTimeString)
    },
    isCheckedTime (value) {

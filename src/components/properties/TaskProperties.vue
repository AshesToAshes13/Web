<template>
  ...
  >
    <div class="flex-none flex items-center justify-end mb-[10px]">
      <PropsButtonClose
        @click="closeProperties"
      />
    </div>
    <div
      id="task-prop-content"
    ...
    <div class="flex-none w-full mt-[8px] mb-[20px]">
      <img
        v-if="isloading"
        class="mt-[8px] h-[40px]"
        src="/ajaxloader.gif"
...
export default {
  ...
  methods: {
    ...
    onInputTaskMsg () {
      ...
      //
      const defHeaderHeight = 30
      const parentHeight = sendHeight + defHeaderHeight
      //

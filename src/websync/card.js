...
export function removeCard (uid) {
  console.log(uid)
  const isDeleteUpdateClientCard = router.currentRoute.value.name === 'clientPage' && store.state.clientfilesandmessages.cards.cards.find(property => property.uid === uid)

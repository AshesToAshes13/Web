...
import { addMegafonCallToClientChat, createMegafonIntegration } from '@/websync/megafonCorpInt.js'
...
import { createClientFile, createClientMessage } from '@/websync/clients_chat'
...
export default function processCreate (obj) {
  switch (obj.type) {
    ...
    case TYPES.TYPE_OBJECT_MEGAFON_CORP_INT:
      ...
      break
    case TYPES.TYPE_OBJECT_MEGAFON_CALL:
      addMegafonCallToClientChat(obj)
      break
    ...
    case TYPES.TYPE_OBJECT_CLIENT_FILE:
      createClientFile(obj)
      break
    case TYPES.TYPE_OBJECT_CLIENT_MSG:
      createClientMessage(obj)
      break

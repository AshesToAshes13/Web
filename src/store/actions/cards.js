export const DOITNOW_CARDS_REQUEST = 'DOITNOW_CARDS_REQUEST'
export const BOARD_CARDS_REQUEST = 'BOARD_CARDS_REQUEST'
export const BOARD_ARCHIVE_CARDS_REQUEST = 'BOARD_ARCHIVE_CARDS_REQUEST'
export const BOARD_ALL_CARDS_REQUEST = 'BOARD_ALL_CARDS_REQUEST'
export const PUBLIC_BOARD_CARDS_REQUEST = 'PUBLIC_BOARD_CARDS_REQUEST'
export const INSPECTOR_CARD_REQUEST = 'INSPECTOR_CARD_REQUEST'
export const BOARD_CARDS_SUCCESS = 'BOARD_CARDS_SUCCESS'
export const PUBLIC_BOARD_CARDS_SUCCESS = 'PUBLIC_BOARD_CARDS_SUCCESS'
...
export const UPDATE_CLIENT_IN_CARD = 'UPDATE_CLIENT_IN_CARD'
...
export const CHANGE_CARD_DATE_REMINDER = 'CHANGE_CARD_DATE_REMINDER'
export const CHANGE_CARD_UID_CLIENT = 'CHANGE_CARD_UID_CLIENT'

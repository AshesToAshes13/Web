...
export const REGLAMENT_CONTENT_REQUEST = 'REGLAMENT_CONTENT_REQUEST'
...
export const UPDATE_ADD_USERS_REGLAMENT_PASSED = 'UPDATE_ADD_USERS_REGLAMENT_PASSED'
...
export const GET_REGLAMENT_COMMENTS = 'GET_REGLAMENT_COMMENTS'
export const CREATE_REGLAMENT_COMMENT = 'CREATE_REGLAMENT_COMMENT'

export const SET_REGLAMENT_REMINDER = 'SET_REGLAMENT_REMINDER'
export const SET_REGLAMENT_COMMENTS = 'SET_REGLAMENT_COMMENTS'
// мутации
export const RESET_REGLAMENTS_STATE = 'RESET_REGLAMENTS_STATE'
...
// websync
export const CHANGE_REGLAMENT = 'CHANGE_REGLAMENT'

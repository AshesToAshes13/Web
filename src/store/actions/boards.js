...
export const CHANGE_BOARD_COMMENT = 'CHANGE_BOARD_COMMENT'
...
export const CHANGE_STAGE_BOARD = 'CHANGE_STAGE_BOARD'

export const SEND_BOARD_FORM_REQUEST = 'SEND_BOARD_FORM_REQUEST'

export const CHANGE_BOARD_DEPARTMENTS = 'CHANGE_BOARD_DEPARTMENTS'

export const PUBLIC_LINK_STATUS_BOARD_REQUEST =
  'BOARD.PUBLIC_LINK_STATUS_BOARD_REQUEST'

...
export const GET_CARDS_MESSAGES = 'GET_CARDS_MESSAGES'
export const CLIENT_CARDS_MESSAGES_SUCCESS = 'CLIENT_CARDS_MESSAGES_SUCCESS'
export const CLIENT_CARDS_SUCCESS = 'CLIENT_CARDS_SUCCESS'
export const SET_CLIENT_CARDS = 'SET_CLIENT_CARDS'
...
export const GET_CARDS_FILES = 'GET_CARDS_FILES'
export const CLIENT_CARDS_MERGE_FILES = 'CLIENT_CARDS_MERGE_FILES'
export const CHANGE_MESSAGE = 'CLIENT_CHANGE_MESSAGE'

export const SUCCESS_LOADING = 'SUCCESS_LOADING'

export const REMOVE_MESSAGE_FROM_CARD = 'CLIENT_REMOVE_MESSAGE_FROM_CARD'
...
export const PUSH_CALL_HISTORY = 'PUSH_CALL_HISTORY'

export const ADD_UPDATE_CLIENT_CARD = 'ADD_UPDATE_CLIENT_CARD'
export const DELETE_UPDATE_CLIENT_CARD = 'DELETE_UPDATE_CLIENT_CARD'
export const UPDATE_CLIENT_CARD_NAME = 'UPDATE_CLIENT_CARD_NAME'
